...
export class Tab1Page implements OnInit, AfterViewInit {
    ...
    toggleMenu() {
        const menu = document.getElementsByClassName('ins-menu')[0] as HTMLElement;
        const menuBtn = document.getElementsByClassName('ins-bottom-menu-button')[0] as HTMLElement;
        const menuBar = document.getElementsByClassName('ins-bottom-menu')[0] as HTMLElement;
